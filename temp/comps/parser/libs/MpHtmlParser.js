...
module.exports = {
  ...
  // 信任的标签
  trustTags: makeMap('figure,a,abbr,ad,audio,b,blockquote,br,code,col,colgroup,dd,del,dl,dt,div,em,fieldset,h1,h2,h3,h4,h5,h6,hr,i,img,ins,label,legend,li,ol,p,q,source,span,strong,sub,sup,table,tbody,td,tfoot,th,thead,tr,ul,video' + (canIUse ? ',bdi,bdo,caption,pre,rt,ruby' : '')),
  // 默认的标签样式
  userAgentStyles: {
    hr: 'border:1rpx solid rgba(122, 122, 122, 0.2);',
    address: 'font-style:italic',
    big: 'display:inline;font-size:1.2em',
    blockquote: 'border-left: 3px solid rgba(122, 122, 122, 0.3); background-color: rgba(122, 122, 122, 0.1);padding:5px 0 5px 10px',
    caption: 'display:table-caption;text-align:center',
    center: 'text-align:center',
    cite: 'font-style:italic; font-size:26rpx;',
    dd: 'margin-left:40px',
    mark: 'background-color:yellow',
    pre: 'font-family:monospace;white-space:pre;overflow:scroll;font-size:14px;line-height:18px;',
